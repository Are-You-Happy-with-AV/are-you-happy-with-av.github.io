<div style="background:#fff; border-radius:12px; padding:30px; max-width:1200px; margin:auto; box-shadow:0 4px 15px rgba(0,0,0,0.1); font-family:Arial, sans-serif; line-height:1.6;">
