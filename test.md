<div style="background:#fff; border-radius:12px; padding:30px; max-width:900px; margin:auto; box-shadow:0 4px 15px rgba(0,0,0,0.1); font-family:Arial, sans-serif; line-height:1.6;">
...
<div style="font-size:26px; font-weight:bold; margin-bottom:20px; text-align:center;">
  ...
  <div style="display:flex; align-items:flex-start; margin-bottom:20px;">
    ...
    <div>
      <h3 style="margin:0;">Prof. Dr. Junmin Wang</h3>
      ...
      <p style="margin-top:8px; font-size:14px;line-height:1.0;">
